...
export const BOARDS: Board[] = [
  ...
  { id: 'board3', name: '我的智库', icon: '📚' },
  { id: 'board4', name: '我的', icon: '👤' },
]
...
export const MODULES: ModuleMeta[] = [
  ...
  // ===== 板块二·升值涨薪 =====
  {
    ...
    container: 'chat', icon: '🎙️', hasPage: true,
  },
  {
  ...
  // ===== 板块三·我的智库 =====
  {
    code: 'M12', slug: 'knowledge-base', name: '公私智库', board: 'board3',
    slogan: '随手存结晶，终成你底气', subtitle: '所有产出自动归档，RAG 语义检索一问就找到',
    container: 'dashboard', icon: '🗂️', hasPage: true,
  },
  {
    code: 'M13', slug: 'data-analytics', name: '数据分析', board: 'board3',
