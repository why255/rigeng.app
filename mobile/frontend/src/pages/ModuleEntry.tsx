...
import { getModuleBySlug } from '@/shared/data/modules'
import { PageContainer } from '@/components/layout/AppShell'
import { Card, Button, Text, Tag } from '@/shared/components/primitives'
import './pages.css'
...
export function ModuleEntry() {
  ...
  const corePath: Record<string, string> = {
    ...
    'smart-qa': `/m/smart-qa`,
    'smart-office': `/m/smart-office/home`,
    'career-mentor': `/m/career-mentor`,
