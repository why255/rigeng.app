...
import { Card, Text, Tag, Button, ProgressBar } from '@rigeng/shared/components/primitives';
import { useToast } from '@rigeng/shared/components/primitives/toast';
import * as knowledgeApi from '@rigeng/shared/api/knowledge';
import type { DocStats, DocumentItem, Category, SearchResult } from '@rigeng/shared/api/knowledge';
import '../pages.css';
