...
import type { WeeklyProgress, ReviewHistoryItem } from '@/api/reviews';
          ...
          {loading ? (
            ...
            <>
              {isDesktop ? (
                ...
                /* 移动端：圆点矩阵 */
                <div className="er-week-dots">
                  {weekly.days.map((d) => (
                    <div key={d.day} className="er-week-dot">
                      <div
                        className={`er-week-dot__circle ${
                          d.status === 'completed'
                            ? 'er-week-dot__circle--completed'
                            : d.status === 'in_progress'
                              ? 'er-week-dot__circle--in-progress'
                              : 'er-week-dot__circle--pending'
                        }`}
                      />
                      <span className="er-week-dot__label">{d.day}</span>
                    </div>
                  ))}
                </div>
              )}
