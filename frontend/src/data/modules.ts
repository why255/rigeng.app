...
export const MODULES: ModuleMeta[] = [
  ...
  // ===== 板块五·我的 =====
  {
    code: 'M14', slug: 'membership', name: '会员中心', board: 'board5',
    slogan: '升级会员，解锁更多', subtitle: '查看会员权益与使用数据',
    container: 'dashboard', icon: '⭐', hasPage: false,
  },
  {
    code: 'M15', slug: 'journey', name: '日耕历程', board: 'board5',
    slogan: '每一步都算数', subtitle: '128天 · 你的成长轨迹',
    container: 'dashboard', icon: '🌱', hasPage: false,
  },
]
