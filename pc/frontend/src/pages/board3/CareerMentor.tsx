...
import { Card, Text, ProgressBar, Tag, Button } from '@/shared/components/primitives'
import { StepFlow, RolePanel, type Step } from '@/shared/components/business'
import { RadarChart } from '@/shared/components/business/charts'
import { careerSteps, abilityRadar, offerCompare } from '@/shared/data/mock'
import '../pages.css'
